...
func _initialize() -> void:
	var paths := [
		...
		"res://scripts/creation_hub/studio_guide_data.gd",
	...
	for path in paths:
		...
		var script_cannot_instantiate := resource is Script and not (resource as Script).can_instantiate()
		if resource == null or script_cannot_instantiate:
