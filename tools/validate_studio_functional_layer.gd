...
func _initialize() -> void:
	...
	scripts.append_array(data_model.find_all_of_class("LocalScript"))
	var script_ok := false
	for script_node_variant in scripts:
		if script_node_variant is Node and str((script_node_variant as Node).get_meta("code", "")).contains("print"):
			script_ok = true
			break
