...
func _run() -> void:
	...
	var bounded_batch_rendering := max_live_viewports <= FRIENDS_BUILDER.AVATAR_PREVIEW_RENDER_BATCH_SIZE
	...
	var ok := textures_ready and queue_drained and no_lingering_viewports and bounded_batch_rendering and frame_budget_ok
	print(
