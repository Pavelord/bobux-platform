...
ssh "${SERVER_USER}@${SERVER_IP}" "BOBUX_API_URL='${BOBUX_API_URL:-http://127.0.0.1:3000/api}' BOBUX_SERVICE_KEY='${BOBUX_SERVICE_KEY:-bobux-server-compat}' BOBUX_SERVER_HEARTBEAT_TOKEN='${BOBUX_SERVER_HEARTBEAT_TOKEN:-}' PUBLIC_SERVER_WS_URL='ws://109.71.245.162/ws' bash /tmp/deploy_remote.sh"
